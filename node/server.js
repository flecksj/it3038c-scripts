...
var free_memory_in_kb = free_memory/1024
var free_memory_in_mb = free_memory_in_kb/1024
...
var uptime = (" Up time: " + ut_day + " Day(s): " + ut_hour + " Hour(s): " + ut_min + " Minute(s): " + ut_sec + " Seconds:")
...
var server = http.createServer(function(req, res) {
    if (req.url === "/" ) {
        ...
        <body>
            ...
            <p>Free Memory: ${free_memory_in_mb} MB</p>
